<template>
  <div class="page-container custom-scrollbar">
      ...
      <div class="flex items-center gap-4">
        ...
        <div>
          ...
          <p class="section-subtitle font-mono">
            ОФЗ, КОРПОРАТИВНЫЕ ОБЛИГАЦИИ MOEX
          </p>
        </div>
      </div>
      <div class="tab-group">
    ...
    >
      <div class="w-3 h-3 border-2 border-teal-500 border-t-transparent rounded-full animate-spin" />
    ...
    <div class="flex-1 flex flex-col gap-6">
      ...
      >
            ...
            <tbody class="text-sm font-mono text-gray-300">
              ...
              >
                ...
                <td class="p-4 text-right font-bold text-white">
                  {{ bond.last != null ? bond.last.toFixed(2) : '—' }}
                </td>
                <td class="p-4 text-right">
                  <span
                    v-if="bond.change_pct != null"
                    :class="bond.change_pct >= 0 ? 'text-emerald-400' : 'text-rose-400'"
                ...
                <td class="p-4 text-right text-gray-400 text-xs">
                  {{ bond.volume != null ? formatVolume(bond.volume) : '—' }}
                </td>
              </tr>
            </tbody>
          </table>
        ...
        <div
          v-if="!loading && ofzBonds.length === 0 && !loadError"
      ...
      <!-- ═══ Corporate Bonds ═══ -->
      <div
        v-else-if="section === 'ALLQ'"
        class="flex flex-col h-full gap-6"
      >
        <h3 class="text-lg font-bold text-white">
          Корпоративные облигации MOEX
        </h3>

        <div
          v-if="corpBonds.length > 0"
          class="flex-1 overflow-auto rounded-2xl border border-white/5 bg-black/20"
        >
          <table class="w-full text-left border-collapse">
            <thead>
      ...
      <div
        v-else-if="section === 'PICK'"
        class="flex flex-col h-full gap-6"
      >
        <h3 class="text-lg font-bold text-white">
          Ставки ЦБР: Депозиты и Репо
        </h3>
        <div
          ...
          <table class="w-full text-left border-collapse">
            ...
            <tbody class="text-sm font-mono text-gray-300">
              ...
              >
                ...
                <td class="p-4 text-right text-teal-400">
