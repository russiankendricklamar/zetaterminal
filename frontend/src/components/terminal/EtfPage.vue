<template>
  <div class="page-container custom-scrollbar">
      ...
      <div class="flex justify-between items-center w-full">
        <div>
          ...
          <p class="section-subtitle font-mono">
            БИРЖЕВЫЕ ФОНДЫ — MOEX И МЕЖДУНАРОДНЫЕ
          </p>
        </div>
        <div class="tab-group">
          <button
    ...
    >
        ...
        <table class="w-full text-left border-collapse">
          <thead>
            <tr class="text-xs text-gray-500 border-b border-white/5 uppercase tracking-wider">
              <th class="font-bold py-4 px-4 pl-0">
                Тикер
              </th>
          ...
          <tbody class="text-sm font-medium">
            ...
            >
              ...
              <td class="py-3 px-4 text-right">
                <span
                  v-if="etf.change_pct != null"
                  :class="etf.change_pct >= 0 ? 'text-emerald-400' : 'text-rose-400'"
      ...
      <div
        v-if="!loading && etfs.length === 0 && !loadError"
