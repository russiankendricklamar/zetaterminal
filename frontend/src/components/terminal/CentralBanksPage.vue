      ...
      <div class="flex items-center gap-4">
        ...
        <div>
          ...
          <p class="section-subtitle font-mono">
            ДЕНЕЖНО-КРЕДИТНАЯ ПОЛИТИКА, СТАВКИ, ЛИКВИДНОСТЬ
          </p>
        </div>
      </div>
      <div class="tab-group">
      ...
      >
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div class="p-6 rounded-2xl bg-white/5 border border-white/5">
            ...
            <div class="text-3xl font-bold text-rose-400">
          ...
          <div class="p-6 rounded-2xl bg-white/5 border border-white/5">
            ...
            <div class="text-3xl font-bold text-white">
              {{ ruoniaRate != null ? ruoniaRate.toFixed(2) + '%' : '—' }}
            </div>
        ...
        >
          ...
          <table class="w-full text-left border-collapse">
            ...
            <tbody class="text-sm font-mono text-gray-300">
              <tr
                v-for="(item, i) in keyRateHistory"
                :key="i"
              ...
              >
                ...
                <td class="p-4 text-right">
                  <span
                    v-if="i < keyRateHistory.length - 1"
                    :class="item.rate > keyRateHistory[i + 1].rate ? 'text-rose-400' : item.rate < keyRateHistory[i + 1].rate ? 'text-emerald-400' : 'text-gray-500'"
                  >
