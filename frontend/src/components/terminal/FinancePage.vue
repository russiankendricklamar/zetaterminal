<template>
  <div class="flex-1 flex gap-6 min-h-0">
    <div class="flex-1 data-panel flex flex-col">
      <h2 class="section-title font-anton text-xl mb-8">
        PORTFOLIO OVERVIEW
      </h2>
      <div class="flex items-center gap-8 mb-8 pb-8 border-b border-white/5">
        <div class="flex-1">
          <div class="text-sm text-gray-400 mb-1 uppercase tracking-wider font-bold">
            Total Balance
          </div>
          <div class="text-5xl font-bold text-white tracking-tight">
            $42,301.54 <span class="text-sm text-emerald-400 font-normal ml-2 bg-emerald-500/10 px-2 py-1 rounded">+12.4%</span>
          </div>
        </div>
      ...
      <div class="flex-1 flex gap-12 items-center">
        ...
        <div class="w-1/2 space-y-4">
          <div
            ...
            :key="item.name"
            class="flex justify-between items-center p-4 rounded-2xl bg-white/5 border border-white/5 hover:bg-white/10 transition-colors cursor-pointer group"
    ...
    <div class="w-96 data-panel flex flex-col">
      <h2 class="section-title font-anton text-lg mb-6">
        RECENT ACTIVITY
      </h2>
        ...
        >
          <div class="flex items-center gap-4">
            <div :class="['p-3 rounded-xl', i % 2 === 0 ? 'bg-emerald-500/10 text-emerald-400' : 'bg-rose-500/10 text-rose-400']">
              <component
                :is="i % 2 === 0 ? ArrowDownLeftIcon : ArrowUpRightIcon"
                class="w-4 h-4"
              />
            </div>
            <div>
          ...
          <div class="text-right">
            ...
            <div class="text-[10px] text-gray-500 bg-white/5 inline-block px-1.5 py-0.5 rounded mt-1">
              Success
            </div>
          </div>
        </div>
      ...
      <div class="mt-4 pt-4 border-t border-white/5">
        <div class="p-6 rounded-3xl bg-gradient-to-br from-gray-800 to-black border border-white/10 relative overflow-hidden group cursor-pointer">
          <div class="relative z-10">
            <div class="text-xs text-gray-400 mb-2 uppercase tracking-widest font-bold">
              Nexus Card
            </div>
            <div class="text-xl font-mono text-white tracking-widest mb-4">
              **** **** **** 4921
            </div>
