        ...
        <section class="hero">
          ...
          <div class="subtitle-frame">
            <p class="hero-subtitle">
              Руководства, глоссарий терминов, описание архитектуры и математические модели Zeta Terminal.
            </p>
          </div>
      ...
      <div class="docs-content" ref="contentRef">
        <div class="content-container">
          ...
          <section v-if="activeSection === 'overview'" class="content-section">
            <h2>Обзор платформы Zeta Terminal</h2>
            <p>
              <strong>Zeta Terminal</strong> — комплексная веб-платформа для количественного анализа финансовых инструментов, управления портфельным риском и ценообразования деривативов на базе стохастических моделей и современных методов машинного обучения.
            </p>
          ...
          <section v-if="activeSection === 'architecture'" class="content-section">
            ...
            <p>
              Zeta Terminal построен на модульной архитектуре с четким разделением функциональности и единообразным интерфейсом для всех страниц.
            </p>
